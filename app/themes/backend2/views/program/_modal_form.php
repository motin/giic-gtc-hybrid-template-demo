...
?>
    ...
    <div class="modal-header">
        ...
        <h3><?php echo Yii::t('model', 'Create {model}', array('{model}' => Yii::t('model', 'Program'))); ?></h3>
    </div>
    <div class="modal-body">

        <?php
        $this->renderPartial('/program/_elements', array(
            'model' => $model,
            'form' => $form,
        ));
        ?>
    ...
    <div class="modal-footer">
        ...
        <?php
        echo CHtml::ajaxSubmitButton('Save', CHtml::normalizeUrl(array('program/editableCreator', 'render' => true)), array(
            'dataType' => 'json',
            'type' => 'post',
